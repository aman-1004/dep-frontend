        ...
        <div className='max-w-screen-lg mx-auto bg-white py-4'>
            <div className='flex items-center place-content-center space-x-14 my-4'>
                ...
                <div className='flex-col '>
                    <h1 className='text-2xl font-semibold'>Indian Institute of Technology Ropar</h1>
            ...
            <div className='border-t-4 border-gray-300 my-2 flex'>
                <p className='m-4 text-lg'>
                    ...
                    <p className='mb-4'>
                        This is to inform that Applicant's application for Leave Travel Concession (LTC) for the year <span className='font-bold'> [Insert Year] </span> has been approved by the management.
                    </p>
