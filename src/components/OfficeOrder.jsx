  ...
  return (
    <div className="max-w-screen-lg mx-auto bg-white py-4">
      ...
      <div className="flex place-content-around space-x-32 mb-4">
        ...
        <p>Date:{new Date(ltcData.fillDate).toISOString().substring(0, 10)}</p>
      </div>
      ...
      <div className="border-t-4 border-gray-300 my-2 flex">
        <p className="m-4 text-lg">
          ...
          <p className="mb-4">
            ...
            </span>{" "} for Leave Travel
            Concession (LTC) for the year{" "}
            <span className="font-bold">
          ...
          <div className="mb-32">
            ...
            <li>
              Journey Duration: {new Date(ltcData.fromDate).toISOString().substring(0, 10)} - {new Date(ltcData.toDate).toISOString().substring(0, 10)}
            </li>
            <li>
