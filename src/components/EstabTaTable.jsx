    ...
    <>
      <ul>
        <li className="py-8 flex space-x-1 items-center">
          ...
          <span contentEditable className="whitespace-nowrap font-medium">{`${ltcData.user.firstName} ${ltcData.user.lastName}`}</span>
        ...
        <li>
          ...
          <span contentEditable className="mx-2 whitespace-nowrap font-medium">{`${ltcData.user.firstName} ${ltcData.user.lastName}`}</span>
          .
        </li>
      </ul>
    </>
